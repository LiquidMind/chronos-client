...
commandList = [Command([u'позвони', u'звони'], [[(u'мансуру', u'mansur', u'monster', u'максиму', u'мансуров'), (u'асхату', u'асхат'), (u'феде', u'федя')],
               ...
               Command([u'набери'],
                       [[(u'мансура',), (u'асхата', u'асхатов', u' асхат'), (u'федю', u'сейчас', u'хейзел', u'север')],
                        [u'mansur', u'asxat', u'fedya']], 1),
               Command([u'алло', u'принять', u'принять звонок', u'принять входящий', u'приня2ть входящий звонок',
                        u'ответить', u'ответь', u''], [], 3),
               Command([u'отклонить', u'отклонить вызов', u'отколони вызов', u'отменить',
                        u'положи трубку', u'положить трубку'], [], 4),
               Command(
                   [u'завершить', u'завершить вызов', u'завершить вызов', u'решить вызов' u'клади трубку'],
                   [], 2),
               Command([u'отбой'], [], 5)
               ]
